...
<a href="#home" className="text-sm font-light tracking-wide hover:text-gray-300
transition-colors">ACCUEIL</a>
<a href="#about" className="text-sm font-light tracking-wide hover:text-gray-300
transition-colors">À PROPOS</a>
<a href="#galleries" className="text-sm font-light tracking-wide
hover:text-gray-300 transition-colors">GALERIES</a>
<Link href="/galleries" className="text-sm font-light tracking-wide
hover:text-gray-300 transition-colors">GALERIES</Link>
<a href="#blog" className="text-sm font-light tracking-wide hover:text-gray-300
transition-colors">BLOG</a>
<a href="#contact" className="text-sm font-light tracking-wide hover:text-gray-300
...
<div className={`transform transition-all duration-1000 ${isLoaded ? 'translate-y-0
opacity-100' : 'translate-y-10 opacity-0'}`}>
...
<div>
<h2 className="text-5xl font-thin tracking-widest mb-8">JEAN PHILIPPE
TOURIGNY</h2>
<div className="w-24 h-px bg-white mb-8" />
</div>
<div className="space-y-6 text-lg font-light leading-relaxed text-gray-300">
<p>
l&apos;élégance avec une approche
Visionnaire de la mode contemporaine, Jean Philippe Tourigny redéfinit
moderne et audacieuse. Formé dans les ateliers parisiens les plus prestigieux.
</p>
<p>
Ses créations allient savoir-faire traditionnel et innovation technique, créant des
...
<Link
href="/interview"
className="inline-block px-8 py-3 border border-white text-white font-light
tracking-wide hover:bg-white hover:text-black transition-colors duration-300"
>
...
mb-4">{gallery.subCollections.length} Collections</p>
...
Découvrez l&apos;univers de la haute couture, nos inspirations et les coulisses de
...
<h3 className="text-xl font-light tracking-wide mb-3 group-hover:text-gray-300
transition-colors">
{post.title}
</h3>
